 ...
 * @endcode
 */
$settings['hash_salt'] = 'GHCmUybdvdmGgGUnh9x5CQFq1ZdlQPQ969tnS3TORKFK57D6NGb6aW2QalBZJ2t_lJJ2NhOtsQ';
...
$config['social_auth_vk.settings']['client_id'] = getenv('VK_CLIENT_ID');
$config['social_auth_vk.settings']['client_secret'] = getenv('VK_CLIENT_SECRET');
